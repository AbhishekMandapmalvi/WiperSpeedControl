###########################################################################
## Makefile generated for component 'WiperSystemControl'. 
## 
## Makefile     : WiperSystemControl.mk
## Generated on : Wed Apr 16 17:37:49 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\WiperSystemControl.exe
...
COMPILER_COMMAND_FILE     = WiperSystemControl_comp.rsp
CMD_FILE                  = WiperSystemControl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\WiperSystemControl.exe
...
DEFINES_STANDARD = -DMODEL=WiperSystemControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\WiperSystemControl_grt_rtw\WiperSystemControl.c $(START_DIR)\WiperSystemControl_grt_rtw\WiperSystemControl_data.c
...
OBJS = WiperSystemControl.obj WiperSystemControl_data.obj
...
{$(START_DIR)\WiperSystemControl_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WiperSystemControl_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WiperSystemControl_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WiperSystemControl_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
WiperSystemControl.obj : "$(START_DIR)\WiperSystemControl_grt_rtw\WiperSystemControl.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\WiperSystemControl_grt_rtw\WiperSystemControl.c"


WiperSystemControl_data.obj : "$(START_DIR)\WiperSystemControl_grt_rtw\WiperSystemControl_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\WiperSystemControl_grt_rtw\WiperSystemControl_data.c"
